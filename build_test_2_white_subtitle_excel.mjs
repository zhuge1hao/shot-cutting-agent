...
const rowsPath = "E:/USE/codexhome/fenge/output/test/2/model_optimized/white_subtitle_ocr.json";
const outputDir = "E:/USE/codexhome/fenge/output/test/shot_text_excels";
const outputPath = path.join(outputDir, "test_02_white_subtitle_shot_text.xlsx");
...
function shotNum(row) {
  return Number(String(row.shot_id).replace("ModelShot_", ""));
}
...
const sheet = workbook.worksheets.add("Test_02");
