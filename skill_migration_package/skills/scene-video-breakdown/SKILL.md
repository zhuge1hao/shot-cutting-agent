...
From the `E:\USE\codexhome\fenge` project, run the normal shot cutter first:

```powershell
python E:\USE\codexhome\fenge\shot_cutting_agent.py --video-file "<video.mp4>" --output-dir E:\USE\codexhome\fenge\output\test
```

If a human reference folder is provided, calibrate with it:

```powershell
python E:\USE\codexhome\fenge\shot_cutting_agent.py --video-file "<video.mp4>" --output-dir E:\USE\codexhome\fenge\output\test --reference-img-dir "<reference_img_dir>"
```

Generate the Excel with subtitle-picture alignment:

```powershell
python E:\USE\codexhome\fenge\build_shot_text_excel_unified.py --video-file "<video.mp4>" --output-dir E:\USE\codexhome\fenge\output\test --report-mode reference --disable-same-subtitle-merge
```
...
```text
video: E:\USE\codexhome\fenge\videos\test\5.20-ubras.mp4
reference: E:\USE\codexhome\fenge\videos\test\imgs5.20ubras
```
